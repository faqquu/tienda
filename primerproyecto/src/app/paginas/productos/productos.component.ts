...
export class ProductosComponent {
  Productos: Producto[] = [
    ...
    },
    {
      ...
      descripcion: 'Zapatillas comodas de la marca nike.',
      precioan: 29.99,
      precio: 29.99,
      imagen: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR92IYbT0sWOqyewu4exCpAY_-5zzd_E4Guug&s', // Asegúrate de que esta ruta sea correcta
      disponibilidad: true
    },
    {
      id: 8,
      nombre: 'Chaqueta M65',
      descripcion: 'Chaqueta militar modelo M65.',
      precioan: 89.99,
      precio: 89.99,
      imagen: 'https://http2.mlstatic.com/D_NQ_NP_2X_999069-CBT77615890029_072024-T.webp', // Asegúrate de que esta ruta sea correcta
      disponibilidad: true
    },
    {
      id: 9,
      nombre: 'Remera de Weezer',
      descripcion: 'Remera de algodon de Weezer.',
      precioan: 59.99,
      precio: 59.99,
      imagen: 'https://ae-pic-a1.aliexpress-media.com/kf/S4ee4d1e727a04d41ae14a85b2212ccb2V.jpg_300x300Q70.jpg_.webp', // Asegúrate de que esta ruta sea correcta
      disponibilidad: true
    },
  ];
